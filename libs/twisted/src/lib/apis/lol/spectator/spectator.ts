...
export class SpectatorApi extends BaseApiLol {
     ...
     * @param region
     */
    public async featuredGames(region: Regions): Promise<ApiResponseDTO<FeaturedGamesDTO>> {
     ...
     * @param region
     */
    public async activeGame(
        encryptedSummonerId: string,
        region: Regions,
    ): Promise<ApiResponseDTO<CurrentGameInfoDTO> | SpectatorNotAvailableDTO> {
        const params = {
            encryptedSummonerId,
        }
        try {
